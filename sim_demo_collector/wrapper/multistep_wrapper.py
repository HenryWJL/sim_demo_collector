"""
Adapted from https://github.com/real-stanford/diffusion_policy/blob/main/diffusion_policy/gym_util/multistep_wrapper.py
"""
import numpy as np
...
class MultiStepWrapper(gym.Wrapper):
    ...
    def _get_obs(self, n_steps: Optional[int] = 1) -> Dict:
        """
        Returns:
            obs (dict): each element with shape (n_obs_steps, obs_shape).
        """
